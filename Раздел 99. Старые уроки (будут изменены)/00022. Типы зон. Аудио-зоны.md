...
В опкодах:<br>
'MARKST' — имя зоны ( см. <a href="/dir/gta_sa/nazvanie_zon_dlja_gta_san_andreas/1-1-0-16">Имена игровых зон</a> )<br>
14 — тип зоны ( см. в <a href="/dir/gta_sa/tipy_zon/1-1-0-39">базе данных</a> )
 </div>
</div>
...
<div class="panel panel-default">
 <div class="panel-body">
Здесь:<br>
'LOWRIDE' — аудио-зона<br>
1 - включить аудио-зону ( если 0 - то выключить )<br>
 </div>
</div>

Учтите, что аудио-зоны и игровые зоны ( обычные ) &mdash; это совсем разные вещи. Список известных мне аудио-зон вы можете найти в нашей <a href="/dir/gta_sa/audio_zony/1-1-0-40">базе данных</a>. Рассмотрим подробнее, что находится в файле "Игра&#92;data&#92;maps&#92;**Audiozon.ipl**":
...
<div class="panel panel-default">
 <div class="panel-body">
Здесь:<br>
OTB - имя аудио-зоны ( именно это нужно писать в опкод **0917** )<br>
24 - номер музыки, которая будет играть в зоне. Известные мне номера Вы найдёте в таблице ниже<br>
Остальные параметры - координаты самих зон.
 </div>
</div>

<table class="table table-bordered"><tbody>
<tr><td colspan="2" class="text-center">Таблица номеров музыки в аудио-зонах</td></tr>
<tr><th>Номер</th><th>Музыка</th></tr>
<tr><td>52</td><td>Playback FM</td></tr>
<tr><td>53</td><td>K-ROSE</td></tr>
<tr><td>54</td><td>K-DST</td></tr>
<tr><td>55</td><td>Bounce FM</td></tr>
<tr><td>56</td><td>SFUR</td></tr>
<tr><td>57</td><td>Radio Los Santos</td></tr>
<tr><td>58</td><td>Radio X</td></tr>
<tr><td>59</td><td>CSR</td></tr>
<tr><td>60</td><td>K-JAH West</td></tr>
<tr><td>61</td><td>MasterSounds</td></tr>
<tr><td>62</td><td>WCTR</td></tr>
</tbody></table>

Я не буду останавливаться на аудио-зонах, потому что их не очень часто используют в скрипте. Если будут уроки по скриптам, с использованием аудио-зон мы ещё вернёмся к этому вопросу.|1139|1|0||tipy_zon_i_audio_zonu|1498568976