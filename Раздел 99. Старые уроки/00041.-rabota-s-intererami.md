...
<div class="panel panel-default">
 <div class="panel-body">
Здесь:<br>
1@ - переменная, в которую будет записан номер интерьера<br>
$PLAYER_ACTOR - актёр, номер интерьера которого будет считано
 </div>
</div>
...
<div class="panel panel-default">
 <div class="panel-body">
Здесь:<br>
v$ACTIVE_INTERIOR_NAME - строковая переменная, в которой будет хранится имя интерьера<br>
$PLAYER_ACTOR - актёр, имя интерьера которого будет прочитано
 </div>
</div>
...
<!--IMG1--><img src="https://github.com/wmysterio/scm-scripting-lessons/raw/resources/_pu/0/32493694.png" /><!--IMG1-->|1180|1|0|32493694`png`640`400`400`250``\||rabota_s_intererami|1498919423