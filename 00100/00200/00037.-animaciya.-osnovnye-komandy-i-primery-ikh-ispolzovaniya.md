...
Здесь:\
"LOWRIDER" — название ifp-файла ( см. рисунок ниже )![](https://github.com/wmysterio/scm-scripting-lessons/raw/resources/\_pu/0/15513934.png)
...
![](https://github.com/wmysterio/scm-scripting-lessons/raw/resources/\_pu/0/77197739.png)
...
Здесь:\
0@ — Имя переменной для актёра\
"prtial\_gngtlkB" — название анимации\
"LOWRIDER" — название IFP-файла\
4.0 и 0 0 0 0 — оставляйте так, далее мы детально изучим эти параметры\
...
![](https://github.com/wmysterio/scm-scripting-lessons/raw/resources/\_pu/0/84390702.png)
...
Здесь:\
$PLAYER\_ACTOR - имя переменной актёра\
...
Здесь:\
2@ - хэндл актёра\
"LRGIRL\_IDLE\_TO\_L0" - имя анимации ( не IFP )
...
Неплохо вышло, только камера во втором ролике не совсем корректно стоит. Ваша задача - сделать её нормальной :)|1294|1|0|15513934`png`731`445`400`243``\|77197739`png`729`445`400`244``\|84390702`png`478`127`400`106``||animacija\_osnovnye\_komandy\_i\_primery\_ikh\_ispolzovanija|1498919369
